...
class AnnouncementCardHorizontal extends StatefulWidget {
  const AnnouncementCardHorizontal(
  ...
  @override
  _AnnouncementCardHorizontalState createState() =>
      _AnnouncementCardHorizontalState();
}

class _AnnouncementCardHorizontalState
    extends State<AnnouncementCardHorizontal> {
