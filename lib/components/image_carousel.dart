    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final double topPosition =
            constraints.maxHeight * 0.1; // 10% from the top
        final double rightPosition =
            constraints.maxWidth * 0.1; // 10% from the right
        ...
        return Stack(
          children: [
            ...
            if (_current == 2 || _current == 5)
              Positioned(
                top:
                    topPosition, // Dynamically positioned based on available height
                right:
                    rightPosition, // Dynamically positioned based on available width
                child: Container(
